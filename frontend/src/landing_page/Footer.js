...
function Footer() {
  return (
    <footer style={{backgroundColor:"rgb(240,248,240)"}}>
    <div className="container border-top ">
      <div className="row mt-5">
        <div className="col-3">
          ...
          />
          <p className="mt-3" >
            © 2025,Not Zerodha Broking Limited. All rights reserved.
          </p>
          <div className="row p-3 ">
            <i class="fa-brands fa-x-twitter"></i>

            <i className="fa-brands fa-facebook-f ml-2"></i>
        ...
        <div className="col-3 mb-3" style={{textDecoration:"none"}}>
          <p>Support</p>
          <a href="" >Contact</a>
          <br />
      ...
      <div className="col mt-1 p-3 text-center border-top">
        <a href="" style={{textDecoration:"none"}} className="m-3">NSE</a>
        <a href="" style={{textDecoration:"none"}} className="m-3">BSE</a>
        <a href="" style={{textDecoration:"none"}} className="m-3">MCX</a>
        <a href="" style={{textDecoration:"none"}} className="m-3">Terms & Conditions</a>
        <a href="" style={{textDecoration:"none"}} className="m-3">Policies & procedures</a>
        <a href="" style={{textDecoration:"none"}} className="m-3">Disclosure</a>
        <a href="" style={{textDecoration:"none"}} className="m-3">Disclosures</a>
